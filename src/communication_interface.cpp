...
ros::Publisher AccuracyPub("/sensors/Accuracy", &Accuracy);
...
void sendAccuracy(int16_t accuracy){
  Accuracy.data = accuracy;
  AccuracyPub.publish(&Accuracy);
}
